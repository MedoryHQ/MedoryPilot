export const en = {
  translation: {
    ...
    overview: {
      heros: "Heros",
      herosDescription: "Configure website heros and navigation",
      introduce: "Introduce",
    ...
    heros: {
      hero: "Hero",
      management: "Heros Management",
      managementDescription: "Manage website heros and navigation elements",
      addHero: "Add Hero",
      search: "Search heros...",
      name: "Name",
      position: "Position",
      ...
      form: {
        ...
        contentTranslationsDescription:
          "Fill in hero details for each language",
        name: "Name",
        experience: "Experience",
        visits: "Visits",
        ...
        descriptionPlaceholder: "Enter a brief description for this hero...",
        settings: "Settings",
        status: "Status",
        statusDescription: "Enable this hero for website display",
        active: "Active",
        inactive: "Inactive",
        logo: "Logo",
        ...
        hero: "Hero",
        createdSuccessfully: "Hero created successfully",
        updatedSuccessfully: "Hero updated successfully",
        deletedSuccessfully: "Hero deleted successfully"
      },
      filters: {
        status: "Status",
        all: "All",
    ...
    pageComponents: {
      ...
      form: {
        ...
        settings: "Settings",
        footerOrder: "Footer Order",
        footerOrderPlaceholder: "e.g., 1",
        slug: "Slug",
        slugPlaceholder: "e.g., page Component-1",
        metaInformation: "Meta Information",
        metaTitleLabel: "Meta Title",
        metaTitlePlaceholder: "e.g., page Component",
        metaDescriptionLabel: "Meta Description",
        metaDescriptionPlaceholder:
          "Enter a brief description for this page Component page...",
        metaKeywordsLabel: "Meta Keywords",
        metaKeywordsPlaceholder: "e.g., page Component, page",
        metaImageLabel: "Meta Image",
        pageComponent: "Page Component",
        createdSuccessfully: "Page Component created successfully",
        updatedSuccessfully: "Page Component updated successfully",
        deletedSuccessfully: "Page Component deleted successfully"
      },
      errors: {
    ...
    newses: {
      ...
      form: {
        ...
        slug: "Slug",
        slugPlaceholder: "e.g., news-1",
        background: "Background",
        backgroundLabel: "Drop your background here",
        backgroundDescription: "or click to browse",
        metaInformation: "Meta Information",
        metaTitleLabel: "Meta Title",
        metaTitlePlaceholder: "e.g., news",
        metaDescriptionLabel: "Meta Description",
        metaDescriptionPlaceholder:
          "Enter a brief description for this news page...",
        metaKeywordsLabel: "Meta Keywords",
        metaKeywordsPlaceholder: "e.g., news, page",
        metaImageLabel: "Meta Image",
        news: "News",
        createdSuccessfully: "News created successfully",
        updatedSuccessfully: "News updated successfully",
        deletedSuccessfully: "News deleted successfully"
      },
      filters: {
        showInLanding: "Show in Landing",
        withMeta: "With Meta",
