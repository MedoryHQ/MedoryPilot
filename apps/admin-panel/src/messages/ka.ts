export const ka = {
  translation: {
    ...
    toast: {
      ...
      logout: "გასვლა წარმატებით დასრულდა",
    ...
    overview: {
      heros: "Hero-ები",
      herosDescription: "ვებსაიტის Hero-ის და ნავიგაციის კონფიგურაცია",
      introduce: "შესავალი",
    ...
    heros: {
      hero: "Hero",
      management: "Hero-ების მართვა",
      managementDescription: "მართეთ ვებსაიტის Hero-ები და ნავიგაცია",
      addHero: "Hero-ის დამატება",
      search: "ძებნა...",
      name: "სახელი",
      position: "პოზიცია",
      ...
      status: "სტატუსი",
      actions: "ქმედებები",
      noHerosFound: "Hero-ები ვერ მოიძებნა",
      created: "შექმნილი",
      active: "აქტიური",
      inactive: "არააქტიური",
      edit: "რედაქტირება",
      ...
      form: {
        ...
        contentTranslationsDescription:
          "შეავსეთ Hero-ის დეტალები თითოეული ენისთვის",
        name: "სახელი",
        ...
        description: "აღწერა",
        descriptionPlaceholder: "შეიყვანეთ მოკლე აღწერა ამ Hero-ისთვის...",
        settings: "პარამეტრები",
        status: "სტატუსი",
        statusDescription: "ამ Hero-ის ვებსაიტზე ჩვენება",
        active: "აქტიური",
        inactive: "არააქტიური",
        logo: "ლოგო",
        ...
        hero: "Hero",
        createdSuccessfully: "Hero წარმატებით შეიქმნა",
        updatedSuccessfully: "Hero წარმატებით განახლდა",
        deletedSuccessfully: "Hero წარმატებით წაიშალა"
      },
      filters: {
        status: "სტატუსი",
        all: "ყველა",
    ...
    pageComponents: {
      ...
      addPageComponent: "გვერდის შექმნა",
      ...
      form: {
        ...
        settings: "პარამეტრები",
        footerOrder: "Footer რიგი",
        footerOrderPlaceholder: "მაგ., 1",
        slug: "სლაგი",
        slugPlaceholder: "მაგ., news-1",
        metaInformation: "მეტა ინფორმაცია",
        metaTitleLabel: "მეტა სათაური",
        metaTitlePlaceholder: "მაგ., news",
        metaDescriptionLabel: "მეტა აღწერა",
        metaDescriptionPlaceholder: "შეიყვანეთ მეტა აღწერა ამ სიახლისთვის...",
        metaKeywordsLabel: "მეტა სიტყვები",
        metaKeywordsPlaceholder: "მაგ., news, page",
        metaImageLabel: "მეტა სურათი",
        news: "Სიახლე",
        createdSuccessfully: "Სიახლე წარმატებით შეიქმნა",
        updatedSuccessfully: "Სიახლე წარმატებით განახლდა",
        deletedSuccessfully: "Სიახლე წარმატებით წაიშალა"
      },
      errors: {
    ...
    services: {
      ...
      form: {
        ...
        contentTranslations: "კონტენტი და თარგმანები",
        contentTranslationsDescription:
          "შეავსეთ Სერვისის დეტალები თითოეული ენისთვის",
        title: "სახელი",
        titlePlaceholder: "მაგ., ონლაინ ჯავშანი",
        description: "აღწერა",
        descriptionPlaceholder: "შეიყვანეთ მოკლე აღწერა ამ Სერვისისთვის...",
        settings: "პარამეტრები",
        icon: "სურათი",
