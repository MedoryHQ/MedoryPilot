 ...
 *     description: Returns counts of main entities in the system (headers, introduce, news, services, faqs, blogs, categories, contacts, footers, socials, pages, tariffs).
 *     security:
 *       - cookieAuth: []
 *     tags:
 *       - Admin Overview
